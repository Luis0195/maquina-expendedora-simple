public class MaquinaExpendedoraSimple {
    ...
    public MaquinaExpendedoraSimple() {
        ...
        estacionOrigen = "Leon";
        estacionDestino = "Leon / La Robla";
    }
    
    /**
     * Crea una maquina expendedora de billetes de tren con el 
     * origen siempre en Leon y el destino y precio del billete variables
     */
    ...
    /**
     * Mdifica el precio del billete
     */
    public void setPrecioBillete(int precioNuevoBillete){
        precioBillete = precioNuevoBillete;

    }
    
    /**
     * Reduce el dinero del billete en una cantidad x introducida por
     * el usuario
     */
    public void setDescuento(int descuentoBillete){
        precioBillete -= descuentoBillete;
    }
